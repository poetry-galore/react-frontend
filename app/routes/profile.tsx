  ...
  return (
    <>
      ...
      <div>
        <form
          method="post"
          className="flex flex-col items-center justify-center space-y-4 max-w-[70%]"
        >
          ...
          <Input
            name="penName"
            type="text"
            placeholder="your preferred pen name"
            required
          />
          <Input
            name="bio"
          ...
          <Input
            name="location"
            type="text"
            placeholder="what area are you located in?"
            required
          />
          <Input
            name="languages"
            type="text"
            placeholder="What are your preferred languages?"
            required
          />
          <Button
            size={"sm"}
