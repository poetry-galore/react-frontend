...
export function PoemCard({ poem, children, className }: PoemCardProps) {
  ...
  return (
    <Card
      className={cn(
        "w-11/12 md:w-[750px] mb-10 p-5 rounded-xl border-none overflow-auto shadow shadow-slate-500 hover:bg-slate-200/90 dark:bg-dark dark:hover:bg-slate-800/50 dark:shadow-slate-700",
        className,
      )}
    >
      {
        <CardHeader className="text-start p-1 mb-1">
          <CardTitle className="text-3xl raleway mb-1 antialiased">
      ...
      <CardContent className="p-5 text-start text-lg">{children}</CardContent>
